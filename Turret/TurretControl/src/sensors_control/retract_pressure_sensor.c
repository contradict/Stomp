...
static const int8_t k_is_retract_pressure_sensor_present = 0;
static const char *k_retract_pressure_sensor_device = "/sys/bus/iio/devices/iio:device0/in_voltage4_raw";
...
{
    return (float)raw_retract_pressure;
}
